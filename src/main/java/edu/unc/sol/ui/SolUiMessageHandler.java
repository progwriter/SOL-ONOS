 ...
 */
public class SolUiMessageHandler extends UiMessageHandler {

    private static final String SAMPLE_CUSTOM_DATA_REQ = "solServiceDataRequest";
    private static final String SAMPLE_CUSTOM_DATA_RESP = "solServiceDataResponse";
    ...
    protected Collection<RequestHandler> createRequestHandlers() {
        return ImmutableSet.of(
                new solServiceDataRequestHandler()
        );
    }

    // handler for sample data requests
    private final class solServiceDataRequestHandler extends RequestHandler {

        private solServiceDataRequestHandler() {
