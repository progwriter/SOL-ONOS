...
(function () {
    ...
    // constants
    var dataReq = 'solServiceDataRequest',
        dataResp = 'solServiceDataResponse';
    ...
    angular.module('ovsolService', [])
        .controller('OvsolServiceCtrl',
        ...
        function (_$log_, _$scope_, _wss_, _ks_) {
            ...
            $scope.$on('$destroy', function () {
                ...
                ks.unbindKeys();
                $log.log('OvsolServiceCtrl has been destroyed');
            });

            $log.log('OvsolServiceCtrl has been created');
        }]);
